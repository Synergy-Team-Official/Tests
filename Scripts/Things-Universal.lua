...
local SynergyUI = loadstring(game:HttpGet("https://github.com/Synergy-Hub-Official/SynergyUI-Lib/blob/main/SRC/source.lua"))()
local Window = SynergyUI:CreateWindow({
    Title = "Synergy Hub - Things Universal",
    AccentColor = Color3.fromRGB(0, 255, 100),
    ToggleKey = Enum.KeyCode.RightShift,
    ConfigFile = "SynergyHub_ThingsUniversal.json"
})
...
InfoTab:CreateKeybind({
    ...
    Callback = function(key)
        ...
        Window.Gui.Enabled = menuVisible
    end
})
